...
```
bin/plugin install com.automattic/elasticsearch-statsd/2.3.5.1
```
...
bin/plugin file:///absolute/path/to/current/dir/target/releases/elasticsearch-statsd-2.3.5.1.zip
```
